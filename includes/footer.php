            ...
            <div class="row justify-content-between">
                <div class="col-md-6 col-xl-auto">
                    <div class="widget footer-widget">
                        ...
                        <p class="footer-info">
                            <i class="fal fa-map-marker-alt text-theme me-2"></i> Centerl
                            Park West La, New York<br /><a href="tel:+01234567890" class="text-inherit"><i
                                    class="far fa-phone-alt text-theme me-2"></i>+0 123 456
                                7890</a><br /><a class="text-inherit" href="mailto:info@example.com"><i
                                    class="fal fa-envelope text-theme me-2"></i>info@example.com</a>
                        </p>
                        <h4 class="fs-22 mb-2">Open Hours</h4>
                        <p class="footer-time">
                            Sunday to Friday <span class="time">08:00 - 20:00</span>
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-xl-auto">
                        ...
                        <div class="recent-post-wrap">
                            <div class="recent-post">
                                ...
                                <div class="media-body">
                                    <h4 class="post-title">
                                        <a class="text-inherit" href="blog-details.html">Managing Partner along</a>
                                    </h4>
                            ...
                            <div class="recent-post">
                                ...
                                <div class="media-body">
                                    <h4 class="post-title">
                                        <a class="text-inherit" href="blog-details.html">Senior Counsels. Partnr
                                            along</a>
                                    </h4>
                                    <div class="recent-post-meta">
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-auto text-center">
                    <p class="copyright-text">
                        ...
                        <a href="index.html">Wellnez</a>. All Rights Reserved By
